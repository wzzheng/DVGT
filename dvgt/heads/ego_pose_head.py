...
from dvgt.layers import Mlp
from dvgt.layers.block import Block
from dvgt.heads.head_act import activate_ego_pose
...
class EgoPoseHead(nn.Module):
    ...
    def forward(self, aggregated_tokens_list: list, num_iterations: int = 4) -> list:
        ...
        pose_tokens = pose_tokens.sum(2)    # (B T dim)
    ...
    def trunk_fn(self, pose_tokens: torch.Tensor, num_iterations: int) -> list:
        ...
        for _ in range(num_iterations):
            ...
            # Attention layers.
            pose_tokens_modulated = self.trunk(pose_tokens_modulated)   # (B T dim)
